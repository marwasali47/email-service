...
* The original package name 'com.orange.email-service' is invalid and this project uses 'com.orange.email' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/docs/2.5.12/reference/htmlsingle/#boot-features-security-oauth2-server)
